        ...
        <div class="flex justify-between items-center">
          <div className="w-auto p-2">
            <a className="inline-block" href="/#">
              <img
                src="/assets/thinkingnorthsmartcitieslogosec2.png"
                width="250"
                alt=""
              />
            </a>
          ...
          <ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex items-center w-auto space-x-12">
            <li>
              <a class="text-sm hover:text-red-700 font-medium" href="/about">
                About
              </a>
            </li>
            <li>
              <a class="text-sm hover:text-red-700 font-medium" href="#">
                Timeline
              </a>
            </li>
            <li>
              ...
              <div class="flex flex-wrap -m-4">
                <div class="w-full md:w-1/2 p-4">
                  ...
                  <section class=" overflow-hidden">
                    <div class="container mx-auto px-2 sm:px-4">
                      <h2 class="font-heading mb-6 text-3xl md:text-4xl lg:text-5xl text-red-600 font-black tracking-tight text-center">
                        ...
                        <div class="flex flex-wrap">
                          <div class="w-full">
                            <div class="pb-0.5 bg-gradient-cyan">
                              <div
                                class="py-3.5 px-5 bg-white rounded-3xl"
                                className="accordian"
                              >
                                  ...
                                  <div class="w-auto p-2">
                                    ...
                                    >
                                      <div className=" accordian_question">
                                        <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                    ...
                                    <div className="accordian_answer">
                                      ...
                                      >
                                        A Smart City is an urban development
                                        vision to integrate information and
                                        communication technology (ICT) and
                                        Internet of Things (IoT) technology in a
                                        secure fashion to manage a city's assets
                                        and resources more efficiently for the
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        2. What are the criteria for a city to
                                        become a Smart City?
                                      </p>
                                      <p class="text-base text-black">
                                        The criteria for a city to become a
                                        Smart City include a solid and reliable
                                        ICT infrastructure with efficient energy
                                        management systems, smart
                                        transportation, and mobility solutions.
                                        Moreover, with effective waste
                                        management systems and efficient public
                                        services, including the basic needs like
                                        electricity, water, heating, and other
                                        households that need to be managed
                                        within these areas.
                                      </p>
                                    </div>
                                    <div class="w-auto p-2">
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        3. What is a Smart Cities hackathon?
                                      </p>
                                      <p class="text-base text-black">
                                        A Smart Cities hackathon is where
                                        developers, designers, data scientists,
                                        and other tech-savvy individuals come
                                        together to develop innovative solutions
                                        for urban problems related to the
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        4. Who can participate in a Smart Cities
                                        hackathon?
                                      </p>
                                      <p class="text-base text-black">
                                        Anyone with a passion for technology and
                                        innovation can participate in a Smart
                                        Cities hackathon, including students,
                                        developers, data scientists, and urban
                                        planners, if they think they have a
                                        solution to making an efficient and
                                        effective city transformation that is
                                        technically and realistically feasible.
                                      </p>
                                    </div>
                                    <div class="w-auto p-2">
                                      <svg
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        5. What is the format of a Smart Cities
                                        hackathon?
                                      </p>
                                      <p class="text-base text-black">
                                        A Smart Cities hackathon typically
                                        begins with a series of presentations
                                        and workshops on the theme of Smart
                                        Cities. Participants then form teams and
                                        work on a solution to a specific problem
                                        related to the development of Smart
                                        Cities. The hackathon culminates in a
                                        pitch competition, where teams present
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        6. What solutions are typically
                                        developed during a Smart Cities
                                        hackathon?
                                      </p>
                                      <p class="text-base text-black">
                                        Solutions developed during a Smart
                                        Cities hackathon can range from smart
                                        transportation systems to efficient
                                        energy management systems, from waste
                                        management solutions to public safety
                                        systems, and from smart healthcare
                                        systems to citizen engagement platforms.
                                      </p>
                                    </div>
                                    <div class="w-auto p-2">
                                      <svg
                              ...
                              <div class="pb-0.5 bg-gradient-cyan">
                                <div class="py-3.5 px-5 bg-white rounded-3xl">
                                  <div class="flex flex-wrap items-center justify-between -m-2">
                                    <div class="w-auto p-2">
                                      <p class="mb-5 font-heading font-bold text-lg text-red-700">
                                        7. How can I get involved in a Smart
                                        Cities hackathon?
                                      </p>
                                      <p class="text-base text-black">
                                        You can get involved in a Smart Cities
                                        hackathon by searching for events in
                                        your area or by contacting organizations
                                        specializing in developing Smart Cities.
                                        You can also sign up for updates on
                                        hackathons and other events related to
                                        Smart Cities.
                                      </p>
                                    </div>
                                    <div class="w-auto p-2">
