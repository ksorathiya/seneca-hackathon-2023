            ...
            <form class="p-10 bg-white border border-gray-100 rounded-3xl">
              <div class="flex flex-wrap -m-3 mb-3">
                <div class="w-full p-3">
                  <label class="block mb-2 text-md text-red-500 font-bold" for="contactLightInput4-1">Full Name</label>
                ...
                <div class="w-full p-3">
                  <label class="block mb-2 text-md text-red-500 font-bold" for="contactLightInput4-2">Emaill address</label>
              ...
              <div class="flex flex-wrap -m-3 mb-3">
                <div class="w-full p-3">
                  <label class="block mb-2 text-md text-red-500 font-bold" for="contactLightInput4-3">Phone</label>
                ...
                <div class="w-full p-3">
                  <label class="block mb-2 text-md text-red-500 font-bold" for="contactLightInput4-4">Subject</label>
              ...
              <div class="flex flex-wrap -m-3.5">
                <div class="w-full p-3.5">
                  <label class="block mb-2 text-md text-red-500 font-bold" for="contactLightInput4-5">Message</label>
                  ...
                  <div class="flex flex-wrap items-center -m-3">
                    ...
                    <div class="w-full p-11">
                      <div class="flex flex-wrap md:justify-end -m-2">
                        <div class="w-full p-2"><a class="block w-full px-8 py-3.5 text-lg text-center text-white font-bold bg-red-500 hover:bg-red-700 focus:ring-4 focus:ring-blue-200 rounded-full" href="#">Send Message</a></div>
                      </div>
                    </div>
                  </div>
                </div>
...
<section class="pt-24 pb-36 overflow-hidden">
  <div class="container mx-auto px-4">
    <h2 class="font-heading mb-6 text-4xl md:text-5xl lg:text-6xl text-red-600 font-black tracking-tight text-center">Frequently asked question</h2>
            ...
            <div class="pb-0.5 bg-gradient-cyan">
              <div class="py-3.5 px-5 bg-white">
                <div class="flex flex-wrap items-center justify-between -m-2">
                  ...
                  <p class="mb-5 font-heading font-bold text-lg text-red-700">1. What is a Smart City?</p>
