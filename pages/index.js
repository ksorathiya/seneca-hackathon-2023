    ...
    <>
          ...
          <div className="py-16 px-8 bg-white rounded-3xl">
            <div className="max-w-7xl mx-auto">
              <div className="flex flex-wrap -m-8 mb-10">
                ...
                <div className="w-full md:w-1/4 p-8 my-auto">
                  <img
                    className="mx-auto md:mr-0 rounded-3xl"
      ...
      <section className="py-10 bg-gray-50 overflow-hidden">
        ...
        <section className="py-10 bg-white overflow-hidden">
          <div className="container mx-auto px-4">
            <div className="py-16 px-8 md:px-16 bg-red-700 overflow-hidden rounded-3xl">
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white border border-gray-50 rounded-3xl">
            <div className="flex flex-wrap items-center">
              ...
              <div className="w-full sm:w-1/3 border-b sm:border-r border-gray-50">
                <div className="py-12 lg:py-20 px-8 bg-black">
              ...
              {/* <div className="w-full sm:w-1/3 border-b sm:border-b-0 sm:border-r border-gray-50"></div>
              <div className="w-full sm:w-1/3 border-b sm:border-b-0 sm:border-r border-gray-50"></div>
