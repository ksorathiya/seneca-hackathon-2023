...
<section class="py-16 md:py-24 bg-coolGray-50" style={{"background-image": "url('flex-ui-assets/elements/pattern-light-big.svg'); background-repeat: no-repeat; background-position: center;"}}>
  <div class="container px-4 mx-auto">
    ...
    <div class="md:max-w-3xl mx-auto">
      ...
      <div class="mb-6 p-6 border-l-2 border-green-500">
        <p class="mb-4 text-xl md:text-2xl leading-tight font-medium text-coolGray-800">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus.</p>
        <span class="text-base md:text-lg text-coolGray-400 font-medium">&mdash; John Doe, CEO &amp; Founder</span>
      </div>
      <p class="mb-6 text-base md:text-lg text-coolGray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
      ...
      <p class="mb-8 text-base md:text-lg text-coolGray-400 font-medium">
        ...
        <a class="hover:text-coolGray-500 underline" href="#">ultricies</a>
        <span>vel fringilla.</span>
      </p>
      <h3 class="mb-4 text-2xl md:text-3xl font-semibold text-coolGray-800">Header 1</h3>
      <p class="mb-14 text-base md:text-lg text-coolGray-500">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ullamcorper mattis lorem non. Ultrices praesent amet ipsum justo massa. Eu dolor aliquet risus gravida nunc at feugiat consequat purus. Non massa enim vitae duis mattis. Vel in ultricies vel fringilla.</p>
      <p class="mb-4 text-base md:text-lg text-coolGray-500">Sagittis et eu at elementum, quis in. Proin praesent volutpat egestas sociis sit lorem nunc nunc sit. Eget diam curabitur mi ac. Auctor rutrum lacus malesuada massa ornare et. Vulputate consectetur ac ultrices at diam dui eget fringilla tincidunt. Arcu sit dignissim massa erat cursus vulputate gravida id. Sed quis auctor vulputate hac elementum gravida cursus dis.</p>
      <ol class="list-decimal list-inside md:px-5 mb-14 text-base md:text-lg text-coolGray-500">
        <li>Lectus id duis vitae porttitor enim gravida morbi.</li>
        <li>Eu turpis posuere semper feugiat volutpat elit, ultrices suspendisse. Auctor vel in vitae placerat.</li>
        <li>Suspendisse maecenas ac donec scelerisque diam sed est duis purus.</li>
      </ol>
      <p class="mb-10 pb-10 text-base md:text-lg text-coolGray-500 border-b border-coolGray-100">
        ...
        <a class="text-green-500 hover:text-green-600 underline" href="#">Vivamus id pharetra massa</a>
