    ...
    <>
      ...
      <div class="container mt-12 mb-24  px-6 mx-auto">
        <section class="mb-25 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            <h2 class="font-heading text-5xl md:text-5xl text-red-600 font-black tracking-tight">
              Meet the team of Smart Cities Hackathon!
            </h2>
            <br></br>
            <br></br>
            <h2 class="font-heading text-4xl md:text-4xl text-gray-900 font-black tracking-tight mb-10">
              Leaders
            </h2>
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              Chief of Staff is responsible for volunteer/intern experience,
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Mark_Buchner.jpg"
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/mark-buchner-bb6a7013/"
                      class="px-2"
                    >
                      <img
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Kartik_Sorathiya.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Santosh_Bohara.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Fenil_Mehta.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Neil_javiya.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/neiljaviya/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\David_Jeong.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/david-jeong/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/molikatan/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Shirlene_Phyllis.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
                ...
                <div class="p-6">
                  <h5 class="text-lg font-bold mb-4">
                    Shirlene Phyllis Feliciano
                  </h5>
                  <p class="mb-6">Chief of Staff</p>
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/splfeliciano/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/daisyldct/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/aliraza-m-versi-760692128/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
      ...
      <div class="container my-12 px-6 mx-auto">
        <section class="mb-5 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            <br></br>
            <h2 class="font-heading text-4xl md:text-4xl text-gray-900 font-black tracking-tight mb-1">
              IT Team
            </h2>
            <br></br>
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              The IT department is responsible for the company's technology
              infrastructure. They are in charge of ensuring that all technical
              aspects of the company are running smoothly and efficiently. They
              also provide support to employees who have technical problems.
            </p>
          </div>
          {/* <h2 class="text-3xl font-bold mb-32">Meet the <u class="text-red-600">TEAM</u></h2> */}
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\shivangi_sood.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/shivangi-sood/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Janet_Mejia.JPG"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Kendra_Terrero.png"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
      ...
      <div class="container mt-12 mb-24 px-6 mx-auto">
        <section class="mb-5 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            ...
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              The Student Success Department is responsible to work closely and
              directly with students to serve students and collect students’
              input towards the organization so as to provide the best services
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Nirosan_Perinpanayagam.jpeg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Nithila_Balasubramanian.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Kavitha_Raman.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
      ...
      <div class="container mt-12 mb-24 px-6 mx-auto">
        <section class="mb-5 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            ...
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              The Operation team is responsible for planning, organizing, and
              supervising operations, manufacturing and production processes,
              and service delivery to produce the desired outcome of a
              high-quality product or service that satisfies customer
              demands.The Operation team is responsible for planning,
              organizing, and supervising operations, manufacturing and
              production processes, and service delivery to produce the desired
              outcome of a high-quality product or service that satisfies
              customer demands.
            </p>
          </div>
      ...
      <div class="container mt-12 mb-24 px-6 mx-auto">
        <section class="mb-5 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            ...
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              Marketing Depart is the face of Seneca Hackathon. It is the
              Marketing Department's job to reach out to prospects, customers,
              investors and/or the community, while creating an overarching
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                ...
                <div class="p-6">
                  ...
                  <ul class="list-inside flex mx-auto justify-center">
                    <a
                      href="https://www.linkedin.com/in/tonni-ann-hinds-n%C3%A9e-burgher-3526a8180/"
                      class="px-2"
                    >
                      <img
                        src="/assets/linkedin-logo.png"
      ...
      <div class="container mt-12 mb-24 px-6 mx-auto">
        <section class="mb-5 text-gray-800 text-center">
          <div class="mb-20 max-w-7xl mx-auto text-center">
            ...
            <p class="text-xl md:text-xl text-gray-600 font-medium tracking-tight mb-10 pb-20">
              A finance team is also in charge of all duties related to your
              organization's capital funds, including acquiring and managing
              these funds including accounting, record keeping, administrative
              work, and cash flow.
            </p>
          </div>
            ...
            <div class="mb-24 md:mb-0">
              <div class="rounded-lg shadow-lg h-full block bg-white">
                <div class="flex justify-center">
                  ...
                  >
                    <img
                      src="\assets\team\Dristi_himmatramka.jpg"
                      class="rounded-full mx-auto shadow-lg"
                      alt=""
                      style={{ width: "150px; " }}
                    />
