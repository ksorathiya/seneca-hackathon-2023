                        ...
                        <div class="w-full m-4 md:w-1/3 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Mental Health</p>
                        ...
                        <div class="w-full md:w-1/3 m-4 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Smart Buildings</p>
                        ...
                        <div class="w-full md:w-1/3 m-4 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Data Privacy and Security</p>
                        ...
                        <div class="w-full md:w-1/3 m-4 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Smart Analytics and Insights</p>
                        ...
                        <div class="w-full md:w-1/3 m-4 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Smart Business</p>
                        ...
                        <div class="w-full md:w-1/3 m-4 p-2 block max-w-md bg-white border border-gray-500 border-0 border-b-4 rounded-lg shadow">
                            <div class="md:max-w-md mx-auto text-center p-4">
                                <Image
                                    ...
                                    width={200}
                                />
                                <p class="font-heading hover:underline font-semibold text-3xl text-red-700">Sustainable City</p>
