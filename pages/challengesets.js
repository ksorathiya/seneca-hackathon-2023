        ...
        <>
            ...
            <section class="pt-28 pb-20 bg-white overflow-hidden">
                <div class="container mx-auto px-4">
                    <h2 class="mb-20 font-heading font-serif font-semibold text-6xl sm:text-7xl text-gray-700 text-center">Challenge Sets for Smart Cities Hackathon</h2>
                        ...
                        <div class="w-full md:w-1/3 p-4">
                            <div class="md:max-w-xs mx-auto text-center">
                                <Image
                                    ...
                                    width={75}
                                />
                                <p class="font-heading font-semibold text-xl text-red-700">Data Privacy and Security</p>
                                <p class="font-heading text-justify font-light text-sm text-gray-900">The challenge sets focus on the data privacy and security of ANY stakeholder in the smart city, including marginalized and disenfranchised communities, everyday citizens, small business owners, and city municipal governments..</p>        </div>
                        </div>
                        <div class="w-full md:w-1/3 p-4">
                            <div class="md:max-w-xs mx-auto text-center">
                            <Image
