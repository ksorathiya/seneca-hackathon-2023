export default function DesignJamHero(props) {
  return (
    <div className="bg-white overflow-hidden border border-gray-100 h-full">
      <div
        className="py-6 px-4 md:px-8 md:py-20 w-full h-full flex justify-center items-center 
      ...
      >
        <div className="md:max-w-2xl text-center mx-auto">
          ...
          <h1
            className="font-heading text-2xl md:text-5xl text-black font-black tracking-tight"
          ...
          <p className="text-sm md:text-xl text-black ">
            ...
            <br />
            <span className="text-red-600">Smart Cities Hackathon</span>, in
            association with York University's YSpace.
            <br></br>
            <br></br>
          </p>
