...
export default function Timeline(props) {
  return (
    <div className="container w-full mx-auto md:px-6">
      <div className="py-6 px-4 sm:py-16 sm:px-8 bg-white md:rounded-3xl">
        <div className="max-w-8xl mx-auto">
          <h2 className="font-heading mb-8 lg:mb-20 text-4xl md:text-5xl text-gray-900 font-black tracking-tight">
            Hackathon Timeline (2023)
          </h2>
          <div className="flex flex-wrap sm:-m-3">
            {TimelineData.map((timestamp) => {
              return (
